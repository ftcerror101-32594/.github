...
## 🛠️ Software & Control Systems
Our robot software is written in Java using Android Studio and the official FTC SDK. We structure our codebase around modular subsystem state machines to keep driver controls responsive and autonomous routines repeatable.
